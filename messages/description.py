...
def handle_desc(message, category, good_id):
    """
    Функция отправки пользователю описания товара с указанным id из указанной категории;
    :param category: str
    ...
    bot.send_message(message.from_user.id, 'Описание {}:'.format(good['name']))
    bot.send_message(message.from_user.id, good['desc'])